...
def checkAndBuy(timer = 0, selling = False, boughtAt = 1000000000):
    ...
    try:
        ...
        # elif currentRSI == min(rsi_all) and currentRSI <= threadhold:
            ...
            zig_r = requests.get('https://zignaly.com/api/signals.php?key='+zignaly_key+'&pair=BTCUSDT&type=entry&exchange=binance&positionSizePercentage=16&signalId='+str(num1)+'&limitPrice='+str(currentPrice)+'&buyTTL=7200&DCAAmountPercentage1=50&DCATargetPercentage1=-3&orderType=limit&takeProfitAmountPercentage1=100&takeProfitPercentage1=2&trailingStopDistancePercentage=-0.5&trailingStopTriggerPercentage=1')
